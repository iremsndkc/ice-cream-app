...
const Scoops = () => {
  ...
  const addToBasket = (item) => {
    ...
    if (found) {
      ...
      const uptaded = { ...found, amount: found.amount + 1};

      // dizideki esli elemanı güncelle
      const temp = basket.map((i) => (i.id === found.id ? uptaded : i))
  ...
  return (
    <div>
      ...
      <h3>Çeşitler Ücreti:  <span
      data-testid = "total"
      className="text-success">{total}</span> ₺</h3>
